...
<body>
    ...
    <div class="sidebar">
        <div class="profile_info">
            ...
            <h2 style="font-family: 'Courier New', Courier, monospace;">Hello, Welcome <br> <strong> <span class="mt-2" style="text-align : center; display: block;"> <?php echo $_SESSION['full_name'] ?> </span> </strong> </h2>
        </div>
        <a href="sell-book.php"><i class="fas fa-upload"></i><span>Sell Books</span></a>
